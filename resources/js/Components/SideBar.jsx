        ...
        <>
            <div className="flex h-full flex-col px-3 py-4 md:px-3 md:py-3">
                <Link className="flex items-end justify-start rounded-tr-md rounded-tl-md bg-[#A2A1A80D] p-6" href="/">
                    <div className="w-32 text-white md:w-40 flex items-center gap-1 hover:scale-95 transition">
                        <div className='bg-[#8D75F5] flex justify-center items-center w-10 rounded-full'>
                            <img src='http://127.0.0.1:8000/image/svg/meta-logo.svg' className='w-6 h-10'/>
                        </div>
                ...
                <div className="flex grow flex-row justify-between md:flex-col overflow-auto">
                    ...
                    <div className='flex justify-center rounded-br-md rounded-bl-md bg-[#A2A1A80D]'>
                        <label htmlFor="Toggle3" className="inline-flex items-center rounded-lg cursor-pointer bg-[#A2A1A80D]">
                            ...
                            <span className="px-4 py-2 rounded-lg bg-primary-500 peer-checked:bg-[#A2A1A80D] flex gap-2"><object data='http://127.0.0.1:8000/image/svg/lightOutline.svg' className='stroke-white'/>Light</span>
                            <span className="px-4 py-2 rounded-lg bg-[#A2A1A80D] peer-checked:bg-primary-500 flex gap-2"><img src='http://127.0.0.1:8000/image/svg/darkOutline.svg'/>Dark</span>
                        </label>
                    </div>
