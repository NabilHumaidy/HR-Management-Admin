                ...
                <div className='h-full border p-5 rounded-xl mb-10'>
                    ...
                    <div className='flex flex-col md:flex-row gap-7'>
                        <div className='border rounded-xl flex flex-wrap md:flex-nowrap flex-row md:flex-col h-auto md:h-56 w-auto md:w-[200px]'>
                            {sideTabs.map((tab) => (
                                <Button key={tab.id} onClick={() => setCurrentSideTab(tab.id)} className={`${tab.rounded} h-14 w-full bg-transparent transition delay-150 flex justify-center md:justify-start gap-2 ${currentSideTab === tab.id ? ' bg-primary-500 text-white ' : 'bg-transparent'}`}>
                                    <div className=''>
                                        {tab.icon}
                                    </div>
                                    <p>{tab.label}</p>
