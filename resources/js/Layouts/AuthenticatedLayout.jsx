                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div>
                                <h1 className="font-lexend font-bold text-[20px]">
                                    Hello {user.name} 👋🏻
                                </h1>
                                <p className="font-lexend text-gray-500 opacity-60">
                                    Good Morning
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="hidden md:flex  sm:items-center sm:ms-6  ">
                            <div className="inline-flex rounded-lg border ">
                                ...
                                <input
                                    type="text"
                                    placeholder="Search"
                                    className="border-0 rounded-md opacity-40 border-transparent focus:border-transparent focus:ring-0"
                                />
                            </div>
                            <div className="ms-3 relative flex gap-[20px]  ">
                                <div className="flex w-[50px] h-[40px] bg-gray-100 rounded-md items-center justify-center">
                                    <img
                                        ...
                                        alt=""
                                        className="flex w-[35px] h-[35px]  items-center justify-center "
                                    />
                                </div>
                                <Dropdown>
                                    <Dropdown.Trigger>
